...
{
  uint32_t qSize = StaticCast<RedQueueFrontDisc> (queue)->GetNPackets();
...
int main (int argc, char *argv[])
{
  ...
  std::string prefix_file_name = "front-vs-tail";
  uint32_t sendNum = 45;
  std::string transport_port = "TcpDctcp";
  std::string queue_disc_type = "RedQueueFrontDisc";
  std::string queue_limit = "74p";//almost 100KB buffer
  ...
  uint64_t data_mbytes = 128*1024;
  double minRto = 0.2;//5ms
...
//  Config::SetDefault ("ns3::TcpSocketState::EnablePacing", BooleanValue (true));
  ...
  Config::SetDefault ("ns3::RedQueueFrontDisc::UseEcn", BooleanValue (true));
  Config::SetDefault ("ns3::RedQueueFrontDisc::MaxSize", QueueSizeValue (QueueSize (queue_limit)));
  Config::SetDefault ("ns3::RedQueueFrontDisc::MeanPktSize", UintegerValue (PACKET_SIZE));
  Config::SetDefault ("ns3::RedQueueFrontDisc::Gentle", BooleanValue (false));
  Config::SetDefault ("ns3::RedQueueFrontDisc::UseHardDrop", BooleanValue (false));
  ...
  if(transport_port.compare("TcpDctcp") == 0)
  {
	  ...
	  Config::SetDefault("ns3::RedQueueFrontDisc::QW", DoubleValue (1));
	  Config::SetDefault("ns3::RedQueueFrontDisc::MinTh", DoubleValue (K));
	  Config::SetDefault("ns3::RedQueueFrontDisc::MaxTh", DoubleValue (K));
  }
  ...
  tchRed.SetRootQueueDisc("ns3::RedQueueFrontDisc");
...
//  shortf.SetAttribute("MaxBytes", UintegerValue(204800));//200KB
